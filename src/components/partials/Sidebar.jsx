        ...
        <div className='space-y-8'>
          ...
          <div>
            ...
            <ul className='mt-3'>
                        ...
                        <div className='flex items-center justify-between'>
                          <div className='flex items-center'>
                            <svg className='shrink-0 h-6 w-6' viewBox='0 0 24 24'>
                              <path
                                className={`fill-current ${pathname === '/' ? 'text-indigo-500' : 'text-slate-400'}`}
                                d='M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z'
                              />
                              <path
                                className={`fill-current ${pathname === '/' ? 'text-indigo-600' : 'text-slate-600'}`}
                                d='M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z'
                              />
                              <path
                                className={`fill-current ${pathname === '/' ? 'text-indigo-200' : 'text-slate-400'}`}
              ...
              <SidebarLinkGroup activecondition={pathname === '/games'}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
